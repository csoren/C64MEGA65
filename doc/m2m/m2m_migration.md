...
`CORE-R3.xpr`, `CORE-R4.xpr`, `CORE-R5.xpr`, and `CORE-R6.xpr`.

Additionally, the project file needs updating due to source files added and deleted:
* Remove `vhdl/top_mega65-r3.vhd`.
* Add one of `../M2M/vhdl/top_mega65-r3.vhd`, `../M2M/vhdl/top_mega65-r4.vhd`,
  `../M2M/vhdl/top_mega65-r5.vhd`, or `../M2M/vhdl/top_mega65-r6.vhd`,
...
* Add constraint file, one of  `../M2M/MEGA65-R3.xdc`.  `../M2M/MEGA65-R4.xdc`, `../M2M/MEGA65-R5.xdc`, or `../M2M/MEGA65-R6.xdc`,
  depending upon which board this project is targetting.
...
* There must be a generic `G_BOARD` of type string. This will contain either
  `"MEGA65_R3"`, `"MEGA65_R4"`, `MEGA65_R5`, or `"MEGA65_R6"`.
