...
add_cells_to_pblock pblock_i_hyperram [get_cells [list i_hal_mega65_r3/i_framework/i_hyperram]]
resize_pblock pblock_i_hyperram -add {SLICE_X0Y200:SLICE_X7Y224}

# Place MAX10 close to I/O pins
create_pblock pblock_MAX10
add_cells_to_pblock pblock_MAX10 [get_cells [list i_hal_mega65_r3/MAX10]]
resize_pblock pblock_MAX10 -add {SLICE_X0Y150:SLICE_X7Y174}

# Place Keyboard close to I/O pins
create_pblock pblock_m65driver
add_cells_to_pblock pblock_m65driver [get_cells [list i_hal_mega65_r3/i_framework/i_m2m_keyb/m65driver]]
...
add_cells_to_pblock pblock_sdcard [get_cells [list i_hal_mega65_r3/i_framework/QNICE_SOC/sd_card]]
...
add_cells_to_pblock pblock_vga [get_cells [list i_hal_mega65_r3/i_framework/i_av_pipeline/i_analog_pipeline/VGA_OUT_PHASE_SHIFTED.*]]
...
create_generated_clock -name qnice_clk     [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT0]
create_generated_clock -name hr_clk_x1     [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT1]
create_generated_clock -name hr_clk_x2     [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT2]
create_generated_clock -name hr_clk_x2_del [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT3]
create_generated_clock -name audio_clk     [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT4]
create_generated_clock -name tmds_720p_clk [get_pins i_hal_mega65_r3/i_framework/i_clk_m2m/i_clk_hdmi_720p/CLKOUT0]
...
set_multicycle_path -from [get_cells -include_replicated {{i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/op0_reg[*]} {i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/op1_reg[*]}}] \
   -to [get_cells -include_replicated {i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/res_reg[*]}] -setup 3
set_multicycle_path -from [get_cells -include_replicated {{i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/op0_reg[*]} {i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/op1_reg[*]}}] \
   -to [get_cells -include_replicated {i_hal_mega65_r3/i_framework/QNICE_SOC/eae_inst/res_reg[*]}] -hold 2
...
set_false_path -from [get_pins i_hal_mega65_r3/i_framework/i_reset_manager/reset_core_n_o_reg/C]
