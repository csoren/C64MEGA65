...
set_property -dict {PACKAGE_PIN T5   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[0]}];            # HDMI_D0
set_property -dict {PACKAGE_PIN T4   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[1]}];            # HDMI_D1
set_property -dict {PACKAGE_PIN R3   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[2]}];            # HDMI_D2
set_property -dict {PACKAGE_PIN T1   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[3]}];            # HDMI_D3
set_property -dict {PACKAGE_PIN T6   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[4]}];            # HDMI_D4
set_property -dict {PACKAGE_PIN U1   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[5]}];            # HDMI_D5
set_property -dict {PACKAGE_PIN U5   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[6]}];            # HDMI_D6
set_property -dict {PACKAGE_PIN U6   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[7]}];            # HDMI_D7
set_property -dict {PACKAGE_PIN U2   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[8]}];            # HDMI_D8
set_property -dict {PACKAGE_PIN U3   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[9]}];            # HDMI_D9
set_property -dict {PACKAGE_PIN V4   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[10]}];           # HDMI_D10
set_property -dict {PACKAGE_PIN V2   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[11]}];           # HDMI_D11
set_property -dict {PACKAGE_PIN V3   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[12]}];           # HDMI_D12
set_property -dict {PACKAGE_PIN V5   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[13]}];           # HDMI_D13
set_property -dict {PACKAGE_PIN W1   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[14]}];           # HDMI_D14
set_property -dict {PACKAGE_PIN W2   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[15]}];           # HDMI_D15
set_property -dict {PACKAGE_PIN Y1   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[16]}];           # HDMI_D16
set_property -dict {PACKAGE_PIN Y3   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[17]}];           # HDMI_D17
set_property -dict {PACKAGE_PIN W4   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[18]}];           # HDMI_D18
set_property -dict {PACKAGE_PIN W5   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[19]}];           # HDMI_D19
set_property -dict {PACKAGE_PIN V7   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[20]}];           # HDMI_D20
set_property -dict {PACKAGE_PIN V8   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[21]}];           # HDMI_D21
set_property -dict {PACKAGE_PIN AB1  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[22]}];           # HDMI_D22
set_property -dict {PACKAGE_PIN W6   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[23]}];           # HDMI_D23
set_property -dict {PACKAGE_PIN AB2  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[24]}];           # HDMI_D24
set_property -dict {PACKAGE_PIN W7   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[25]}];           # HDMI_D25
set_property -dict {PACKAGE_PIN AA3  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[26]}];           # HDMI_D26
set_property -dict {PACKAGE_PIN Y7   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[27]}];           # HDMI_D27
set_property -dict {PACKAGE_PIN AB3  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[28]}];           # HDMI_D28
set_property -dict {PACKAGE_PIN Y4   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[29]}];           # HDMI_D29
set_property -dict {PACKAGE_PIN AA4  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[30]}];           # HDMI_D30
set_property -dict {PACKAGE_PIN AA5  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[31]}];           # HDMI_D31
set_property -dict {PACKAGE_PIN AB5  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[32]}];           # HDMI_D32
set_property -dict {PACKAGE_PIN Y6   IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[33]}];           # HDMI_D33
set_property -dict {PACKAGE_PIN AA6  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[34]}];           # HDMI_D34
set_property -dict {PACKAGE_PIN AB6  IOSTANDARD LVCMOS33} [get_ports {hdmi_d_o[35]}];           # HDMI_D35
set_property -dict {PACKAGE_PIN R4   IOSTANDARD LVCMOS33} [get_ports {hdmi_hsync_o}];           # HDMI_HS
set_property -dict {PACKAGE_PIN R6   IOSTANDARD LVCMOS33} [get_ports {hdmi_vsync_o}];           # HDMI_VS
set_property -dict {PACKAGE_PIN R2   IOSTANDARD LVCMOS33} [get_ports {hdmi_de_o}];              # HDMI_DE
set_property -dict {PACKAGE_PIN Y2   IOSTANDARD LVCMOS33} [get_ports {hdmi_clk_o}];             # HDMI_CLK
...
set_property -dict {PACKAGE_PIN V19  IOSTANDARD LVCMOS33} [get_ports {hdmi_cec_clk_o}];         # CEC_CLK
...
# Audio (stereo) to J9
# Microphone input is connected to VP_0/VN_0, which is the FPGA's onboard ADC
...
# Audio (mono) to J19
set_property -dict {PACKAGE_PIN E16  IOSTANDARD LVCMOS33} [get_ports {speaker_pwm_o}];          # PWM_SPEAKER
set_property -dict {PACKAGE_PIN F18  IOSTANDARD LVCMOS33} [get_ports {speaker_mute_n_o}];       # SPEAKER_MUTE_N
