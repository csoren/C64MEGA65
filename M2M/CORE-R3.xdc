...
# Joystick
set_property -dict {PACKAGE_PIN F16  IOSTANDARD LVCMOS33} [get_ports {joy_1_down_n_i}];         # FA_DOWN
set_property -dict {PACKAGE_PIN E17  IOSTANDARD LVCMOS33} [get_ports {joy_1_fire_n_i}];         # FA_FIRE
set_property -dict {PACKAGE_PIN F14  IOSTANDARD LVCMOS33} [get_ports {joy_1_left_n_i}];         # FA_LEFT
set_property -dict {PACKAGE_PIN F13  IOSTANDARD LVCMOS33} [get_ports {joy_1_right_n_i}];        # FA_RIGHT
set_property -dict {PACKAGE_PIN C14  IOSTANDARD LVCMOS33} [get_ports {joy_1_up_n_i}];           # FA_UP
set_property -dict {PACKAGE_PIN P17  IOSTANDARD LVCMOS33} [get_ports {joy_2_down_n_i}];         # FB_DOWN
set_property -dict {PACKAGE_PIN F15  IOSTANDARD LVCMOS33} [get_ports {joy_2_fire_n_i}];         # FB_FIRE
set_property -dict {PACKAGE_PIN F21  IOSTANDARD LVCMOS33} [get_ports {joy_2_left_n_i}];         # FB_LEFT
set_property -dict {PACKAGE_PIN C15  IOSTANDARD LVCMOS33} [get_ports {joy_2_right_n_i}];        # FB_RIGHT
set_property -dict {PACKAGE_PIN W19  IOSTANDARD LVCMOS33} [get_ports {joy_2_up_n_i}];           # FB_UP
...
add_cells_to_pblock pblock_i_hyperram [get_cells [list i_hal_r3/i_framework/i_hyperram]]
...
add_cells_to_pblock pblock_m65driver [get_cells [list i_hal_r3/i_framework/i_m2m_keyb/m65driver]]
...
add_cells_to_pblock pblock_sdcard [get_cells [list i_hal_r3/i_framework/QNICE_SOC/sd_card]]
...
add_cells_to_pblock pblock_vga [get_cells [list i_hal_r3/i_framework/i_av_pipeline/i_analog_pipeline/VGA_OUT_PHASE_SHIFTED.*]]
...
create_generated_clock -name qnice_clk     [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT0]
create_generated_clock -name hr_clk_x1     [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT1]
create_generated_clock -name hr_clk_x2     [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT2]
create_generated_clock -name hr_clk_x2_del [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT3]
create_generated_clock -name audio_clk     [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_qnice/CLKOUT4]
create_generated_clock -name tmds_720p_clk [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_hdmi_720p/CLKOUT0]
create_generated_clock -name hdmi_720p_clk [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_hdmi_720p/CLKOUT1]
create_generated_clock -name tmds_576p_clk [get_pins i_hal_r3/i_framework/i_clk_m2m/i_clk_hdmi_576p/CLKOUT0]
...
set_multicycle_path -from [get_cells -include_replicated {{i_hal_r3/i_framework/QNICE_SOC/eae_inst/op0_reg[*]} {i_hal_r3/i_framework/QNICE_SOC/eae_inst/op1_reg[*]}}] \
   -to [get_cells -include_replicated {i_hal_r3/i_framework/QNICE_SOC/eae_inst/res_reg[*]}] -setup 3
set_multicycle_path -from [get_cells -include_replicated {{i_hal_r3/i_framework/QNICE_SOC/eae_inst/op0_reg[*]} {i_hal_r3/i_framework/QNICE_SOC/eae_inst/op1_reg[*]}}] \
   -to [get_cells -include_replicated {i_hal_r3/i_framework/QNICE_SOC/eae_inst/res_reg[*]}] -hold 2
...
set_false_path -from [get_pins i_hal_r3/i_framework/i_reset_manager/reset_core_n_o_reg/C]
